...
<body>
    <a href="{{ route('change.language', app()->getLocale() == 'en' ? 'ja' : 'en') }}" class="lang-toggle" onclick="return confirm('Change language to {{ app()->getLocale() == 'en' ? 'Japanese' : 'English' }}?')">
        {{ app()->getLocale() == 'en' ? '日本語' : 'English' }}
    </a>
